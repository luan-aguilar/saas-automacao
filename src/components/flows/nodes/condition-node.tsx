...
export function ConditionNodeComponent({ data, selected }: NodeProps<ConditionNode>) {
  ...
  return (
    <NodeShell icon={GitFork} title={data.label || "Condição"} subtitle={subtitle} colorClass="bg-amber-600" selected={selected}>
      ...
      <Handle type="target" position={Position.Top} className="!h-3 !w-3 !bg-amber-600" />
